...
void printFloat_CoordValue(float n) {
    if (BIT_IS_1(settings.flags, BITFLAG_REPORT_INCHES)) {
        printFloat(n * INCH_PER_MM, DECIMAL::COORDVALUE_INCH);
    } else {
        printFloat(n, DECIMAL::COORDVALUE_MM);
    }
}

void printFloat_RateValue(float n) {
    if (BIT_IS_1(settings.flags, BITFLAG_REPORT_INCHES)) {
        printFloat(n * INCH_PER_MM, DECIMAL::RATEVALUE_INCH);
    } else {
        printFloat(n, DECIMAL::RATEVALUE_MM);
    }
}
